...
void filter(int16_t inputy, int16_t input2, int16_t *outputy, int16_t *output2)//o segundo parâmetro pode ser qualquer coisa, nem vou usar.
{
	int16_t out1;
	int16_t out2;
	int16_t out3;
